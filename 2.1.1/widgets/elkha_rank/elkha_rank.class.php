		...
		else
		{
			switch($rank_type)
			{
				case 'point':
					...
					$widget_info->lang_rank_name = $point_config->point_name;
					break;
				case 'friends':
					$widget_info->lang_rank_name = '친구 수';
					break;
				case 'documents':
					$widget_info->lang_rank_name = '게시글 수';
					break;
				case 'comments':
					$widget_info->lang_rank_name = '댓글 수';
					break;
				case 'votes':
					$widget_info->lang_rank_name = '추천 수';
					break;
			}
		}
