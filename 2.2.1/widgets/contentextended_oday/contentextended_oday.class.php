...
$args->hyperlink_type = $args->hyperlink_type ?? 'currentwindow';
...
$gg = $oModuleModel->getGrant(
    $oModuleModel->getModuleInfoByModuleSrl($val->module_srl),
...
$gg = $oModuleModel->getGrant(
	$oModuleModel->getModuleInfoByModuleSrl($msrl),
	$_SESSION['logged_info'] ?? null
);
...
$title = $category_lists[$module_srl][$category_srl]->title ?? '';
$content_item->setCategory($title);
					...
					// 링크 방식 변경(v2.4)
//2025-07-14 Debug ChatGPT	
$domain = Context::get('domain') ?? Context::getDefaultUrl();
					if ($args->hyperlink == 'N') $content_item->setLink("#");
...
$widget_info->new_window = $args->new_window ?? false;
